...
export default function TasksPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Header */}
      <div>
        <h1 className="page-title text-2xl">Tareas</h1>
        ...
        {[
          ...
          <div key={k.label} className="card flex flex-col justify-between p-3.5">
            <div className="flex items-center gap-1.5">
              ...
              <p className="text-[11px] truncate" style={{ color: 'var(--muted)' }}>{k.label}</p>
            </div>
      ...
      {filtered.length === 0 ? (
        ...
        <div
          ...
          style={{ borderColor: 'var(--border)', backgroundColor: 'var(--surface)', divideColor: 'var(--border)' }}
        >
          {filtered.map(task => {
            ...
            // Toggle button styles per status
            const toggleStyle = task.status === 'completed'
              ...
              ? { borderColor: '#F59E0B', backgroundColor: '#FFFBEB', color: '#D97706' }
            ...
            return (
              <div
                ...
                style={{ '--hover-bg': 'var(--surface-soft)' }}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {task.required && (
                    <span className="badge-red mt-1 inline-flex">Requerida</span>
                  )}
                  {task.description && (
                    <p className="mt-0.5 text-[12px] line-clamp-1" style={{ color: 'var(--muted)' }}>{task.description}</p>
                  )}
