...
export default function NewPharmacyPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      toast(err.message || 'Error al crear la farmacia', 'error', 5500)
    } finally {
      setSaving(false)
    }
  }
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6 pb-24">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {hasCb && (
          <Section title="Comunidad de Bienes (C.B.)" subtitle="Datos de la sociedad, titulares y contacto">
        ...
        <Section title="Básculas">
          ...
          {form.bascula !== 'NO' && (<div className="grid grid-cols-2 gap-3">
        ...
        <Section title="Arcos antihurto">
          ...
          {form.antihurto !== 'NO' && (<div className="grid grid-cols-2 gap-3">
        ...
        <Section title="Consultoría">
          ...
          {form.consultoria !== 'NO' && (<div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        ...
        <Section title="Robot dispensador">
          ...
          {form.robot !== 'NO' && (<div className="grid grid-cols-2 gap-3">
        ...
        <Section title="Cruz luminosa">
          <div className="flex gap-2">{['NO','SI','Puede ampliar'].map(opt => <ChipBtn key={opt} active={form.cruz === opt} onClick={() => set('cruz', opt)}>{opt === 'NO' ? 'No tiene' : opt}</ChipBtn>)}</div>
          {form.cruz !== 'NO' && (<div className="grid grid-cols-2 gap-3">
        ...
        <Section title="Gestor de turnos">
          ...
          {form.gestor_turnos === 'SI' && (<div className="grid grid-cols-2 gap-3">
        ...
        <Section title="SPD (Sistema Personalizado de Dosificación)">
          ...
          {form.spd === 'SI' && (<div className="grid grid-cols-2 gap-3">
        ...
        <Section title="Pantallas">
          ...
          {form.pantallas === 'SI' && (
            <div className="space-y-3">
              ...
              <div><Label>Ubicación (puede seleccionar varias)</Label>
