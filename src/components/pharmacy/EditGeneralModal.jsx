...
/**
 * Formulario puro de datos generales.
 * Sin wrapper modal propio — debe montarse dentro de PharmacyEditDrawer.
 * Props: pharmacy, onClose, onSaved
 */
  ...
  async function handleSave() {
    ...
    try {
      ...
      const payload = {
        ...
        sl_data: hasSl ? {
          razon_social: form.sl.razon_social,
          cif:          form.sl.cif,
          phone:        form.sl_contact.phone,
          email:        form.sl_contact.email,
          address:      form.sl_contact.address,
          province:     form.sl_contact.province,
          city:         form.sl_contact.city,
          postal_code:  form.sl_contact.postal_code,
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto overscroll-contain px-5 py-5 space-y-6">
        ...
        {hasSl && (
          <Section
            ...
            subtitle={hasAuto || hasCb ? 'Datos propios de la S.L.' : 'Datos de la sociedad y contacto'}
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <div className="flex items-center justify-end gap-3 px-5 py-4 border-t border-gray-100 bg-white shrink-0">
        ...
        <button
          type="button"
          onClick={handleSave}
          disabled={saving || !form.pharmacy_name.trim()}
