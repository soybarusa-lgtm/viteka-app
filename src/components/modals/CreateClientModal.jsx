...
// ─── Subcomponentes definidos FUERA del padre para evitar re-mount en cada render ───
...
function ProvinceSelect({ provinces, value, onChange }) {
  return (
    ...
    >
      ...
      {provinces.map((p) => (
        <option key={p.code + p.label} value={p.label}>
          {p.label}
        </option>
      ))}
    </select>
...
function CitySelect({ towns, value, onChange }) {
  return (
    ...
    >
      <option value="">
        {towns.length ? 'Selecciona población…' : 'Elige provincia primero'}
      </option>
      {towns.map((t) => (
...
export default function CreateClientModal({ isOpen, onClose, onCreate }) {
  ...
  // Guard: si no está abierto no renderizar nada
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <div className="flex gap-2">
          {[['autonomo', 'Autónomo'], ['cb', 'C.B.'], ['sl', 'S.L.']].map(
            ([val, lbl]) => (
              <button
                key={val}
                type="button"
      ...
      <Field label="Nombre de la farmacia *">
        <input
          ...
          onChange={(e) => {
            ...
            if (legalType === 'autonomo')
              setAutonomo((p) => ({ ...p, pharmacy_name: v }));
            else if (legalType === 'cb')
              setCb((p) => ({ ...p, pharmacy_name: v }));
      ...
      {legalType === 'autonomo' && (
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="Titular *">
              <input
                ...
                value={autonomo.owner_name}
                onChange={(e) =>
                  setAutonomo((p) => ({ ...p, owner_name: e.target.value }))
                }
              />
            </Field>
            <Field label="NIF">
              <input
                ...
                value={autonomo.nif}
                onChange={(e) =>
                  setAutonomo((p) => ({ ...p, nif: e.target.value }))
                }
              />
            </Field>
            <Field label="Nº Colegiado">
              <input
                className={inputCls}
                value={autonomo.colegiado}
                onChange={(e) =>
                  setAutonomo((p) => ({ ...p, colegiado: e.target.value }))
                }
              />
            </Field>
            <Field label="SOE">
              <input
                ...
                value={autonomo.soe}
                onChange={(e) =>
                  setAutonomo((p) => ({ ...p, soe: e.target.value }))
                }
              />
            </Field>
            <Field label="Teléfono">
              <input
                className={inputCls}
                type="tel"
                value={autonomo.phone}
                onChange={(e) =>
                  setAutonomo((p) => ({ ...p, phone: e.target.value }))
                }
              />
            </Field>
            <Field label="Email">
              <input
                className={inputCls}
                type="email"
                value={autonomo.email}
                onChange={(e) =>
                  setAutonomo((p) => ({ ...p, email: e.target.value }))
                }
              />
            </Field>
          </div>
          <Field label="Dirección">
            <input
              className={inputCls}
              value={autonomo.address}
              onChange={(e) =>
                setAutonomo((p) => ({ ...p, address: e.target.value }))
              }
            />
          </Field>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Field label="Provincia">
              <ProvinceSelect
                ...
                onChange={(v) =>
                  setAutonomo((p) => ({ ...p, province: v, city: '' }))
                }
              />
            </Field>
            ...
            <Field label="C.P.">
              <input
                className={inputCls}
                value={autonomo.postal_code}
                onChange={(e) =>
                  setAutonomo((p) => ({ ...p, postal_code: e.target.value }))
                }
              />
            </Field>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="Horario">
              <input
                className={inputCls}
                value={autonomo.schedule}
                onChange={(e) =>
                  setAutonomo((p) => ({ ...p, schedule: e.target.value }))
                }
              />
            </Field>
            <Field label="Guardias">
              <input
                className={inputCls}
                value={autonomo.guards}
                onChange={(e) =>
                  setAutonomo((p) => ({ ...p, guards: e.target.value }))
                }
              />
            </Field>
          </div>
          <Field label="Observaciones">
            <textarea
              rows={3}
              className={inputCls}
              value={autonomo.notes}
              onChange={(e) =>
                setAutonomo((p) => ({ ...p, notes: e.target.value }))
              }
            />
          </Field>
        </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="Razón social">
              <input
                className={inputCls}
                value={cb.razon_social}
                onChange={(e) =>
                  setCb((p) => ({ ...p, razon_social: e.target.value }))
                }
              />
            </Field>
            <Field label="CIF">
            ...
            <Field label="Teléfono">
              <input
                ...
                value={cb.phone}
                onChange={(e) =>
                  setCb((p) => ({ ...p, phone: e.target.value }))
                }
              />
            </Field>
            <Field label="Email">
              <input
                ...
                value={cb.email}
                onChange={(e) =>
                  setCb((p) => ({ ...p, email: e.target.value }))
                }
              />
            </Field>
          </div>
          <Field label="Dirección">
            <input
              ...
              value={cb.address}
              onChange={(e) =>
                setCb((p) => ({ ...p, address: e.target.value }))
              }
            />
          </Field>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <Field label="C.P.">
              <input
                className={inputCls}
                value={cb.postal_code}
                onChange={(e) =>
                  setCb((p) => ({ ...p, postal_code: e.target.value }))
                }
              />
            </Field>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <Field label="Horario">
              <input
                ...
                value={cb.schedule}
                onChange={(e) =>
                  setCb((p) => ({ ...p, schedule: e.target.value }))
                }
              />
            </Field>
            <Field label="Guardias">
              <input
                ...
                value={cb.guards}
                onChange={(e) =>
                  setCb((p) => ({ ...p, guards: e.target.value }))
                }
              />
            </Field>
          </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      value={owner.name}
                      onChange={(e) =>
                        updateCbOwner(i, 'name', e.target.value)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      value={owner.nif}
                      onChange={(e) =>
                        updateCbOwner(i, 'nif', e.target.value)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <input
                      className={inputCls}
                      value={owner.colegiado}
                      onChange={(e) =>
                        updateCbOwner(i, 'colegiado', e.target.value)
                      }
                    />
                  </div>
                </div>
          ...
          <Field label="Observaciones">
            <textarea
              ...
              value={cb.notes}
              onChange={(e) =>
                setCb((p) => ({ ...p, notes: e.target.value }))
              }
            />
          </Field>
        </div>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field label="Razón social">
              <input
                className={inputCls}
                value={sl.razon_social}
                onChange={(e) =>
                  setSl((p) => ({ ...p, razon_social: e.target.value }))
                }
              />
            </Field>
            <Field label="CIF">
            ...
            <Field label="Teléfono">
              <input
                ...
                value={sl.phone}
                onChange={(e) =>
                  setSl((p) => ({ ...p, phone: e.target.value }))
                }
              />
            </Field>
            <Field label="Email">
              <input
                ...
                value={sl.email}
                onChange={(e) =>
                  setSl((p) => ({ ...p, email: e.target.value }))
                }
              />
            </Field>
          </div>
  ...
  return (
    ...
    >
      <div
        ...
        // Evitar que el clic interno propague al overlay
        onClick={(e) => e.stopPropagation()}
      >
        {/* ── Cabecera ── */}
